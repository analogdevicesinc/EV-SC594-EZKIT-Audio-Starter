...
void a2b2AudioOut(void *buffer, uint32_t maxSize, void *usrPtr)
{
    APP_CONTEXT *context = (APP_CONTEXT *)usrPtr;
    ...
    /* Process audio */
    processAudio(context, CLOCK_DOMAIN_BITM_A2B2_OUT, STREAM_ID_A2B2_OUT,
        context->a2b2OutChannels, SYSTEM_BLOCK_SIZE, sizeof(SYSTEM_AUDIO_TYPE),
        buffer, true,
        false, false);
...
void a2b2AudioIn(void *buffer, uint32_t maxSize, void *usrPtr)
{
    APP_CONTEXT *context = (APP_CONTEXT *)usrPtr;
    ...
    /* Process audio */
    processAudio(context, CLOCK_DOMAIN_BITM_A2B2_IN, STREAM_ID_A2B2_IN,
        context->a2b2InChannels, SYSTEM_BLOCK_SIZE, sizeof(SYSTEM_AUDIO_TYPE),
        buffer, false,
        false, true);
