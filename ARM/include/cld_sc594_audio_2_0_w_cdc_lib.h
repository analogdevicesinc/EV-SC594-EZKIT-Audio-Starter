...
/*=============================================================================
    FILE:           cld_sc594_audio_2_0_w_cdc_lib.h
 ...
 *            CLD USB Audio 2.0 and CDC/ACM library using the SC594's Cortex-A5 processor.
 *
 *            Copyright (c) 2023 Closed Loop Design, LLC
 *
 *            This software is supplied "AS IS" without any warranties, express, implied
 ...
 * @param cld_sc594_audio_2_0_w_cdc_lib_params - Pointer to the CLD library initialization parameters,
 * @return The status of the library initialization (CLD_SUCCESS, CLD_FAIL, CLD_ONGOING).
 */
extern CLD_RV cld_sc594_audio_2_0_w_cdc_lib_init (CLD_SC594_Audio_2_0_w_CDC_Lib_Init_Params * p_lib_params);
 ...
 */
extern void cld_sc594_audio_2_0_w_cdc_lib_main (void);
